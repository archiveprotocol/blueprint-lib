...
class BlueprintContext {
    ...
    setWalletAddresses(wallets) {
        this.walletAddresses =
            this.getNetwork() == Number(apy_vision_config_1.CHAINID.SOLANA) ? wallets : wallets.map((wallet) => wallet.toLowerCase());
    }
}
