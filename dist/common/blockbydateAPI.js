...
class BlockbydateAPI {
    ...
    getBlockFromTimestamp(timestamp, networkId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cacheDuration = timestamp == 0 ? archive_axios_1.CacheDuration.NO_CACHE : archive_axios_1.CacheDuration.SHORT_CACHE_DURATION;
            // TODO: use APAxios
    ...
    getDateByBlockAt(blockNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cacheDuration = blockNumber == 0 ? archive_axios_1.CacheDuration.NO_CACHE : archive_axios_1.CacheDuration.SHORT_CACHE_DURATION;
            const network = this.context.getNetwork();
            // TODO: use APAxios
            // const axios = await this.context.getAxios(cacheDuration);
