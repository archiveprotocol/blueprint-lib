...
class EvmContractReader {
    ...
    fetchOrCachedTx(txHash) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const tx = yield (0, web3_wrapper_library_1.executeCallOrSend)(rpcUrls, this.networkId, (provider) => {
    ...
    fetchOrCachedTxReceipt(txHash) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const receipt = yield (0, web3_wrapper_library_1.executeCallOrSend)(rpcUrls, this.networkId, (provider) => {
    ...
    getDecimalPlaces(tokenAddrs) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const decimalsPlaces = yield (0, web3_wrapper_library_1.executeCallOrSend)(rpcUrls, this.networkId, (provider) => {
    ...
    fetchOrCachedGasPrice() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const gasPrice = yield (0, web3_wrapper_library_1.executeCallOrSend)(rpcUrls, this.networkId, (provider) => {
